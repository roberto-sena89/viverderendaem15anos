...
export const CLASSES_GATILHO_ABA =
  "group flex w-full min-w-0 flex-col items-center justify-center gap-1 rounded-lg px-1 py-2 text-center text-[0.625rem] leading-tight font-medium text-muted-foreground transition-colors data-[state=active]:bg-primary/12 data-[state=active]:text-primary data-[state=active]:shadow-none sm:w-auto sm:flex-row sm:gap-1.5 sm:rounded-full sm:px-3.5 sm:py-1.5 sm:text-sm sm:whitespace-nowrap sm:data-[state=active]:bg-primary sm:data-[state=active]:text-primary-foreground";
