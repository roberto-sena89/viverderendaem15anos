...
const MODELOS: Record<Perfil, Omit<LinhaRec, "id">[]> = {
  Conservador: [
    ...
    rv("ETF - Brasil", "BOVA11 ou Trend Bolsa Brasileira", "ETFs - Brasil", 8),
    rv("ETF - Global", "IVVB11 ou Trend Bolsa Americana", "ETFs - Global", 7),
  ...
  Moderado: [
    ...
    rv("ETF - Brasil", "BOVA11 ou Trend Bolsa Brasileira", "ETFs - Brasil", 18),
    rv("ETF - Global", "IVVB11 ou Trend Bolsa Americana", "ETFs - Global", 20),
  ...
  Arrojado: [
    ...
    rv("ETF - Brasil", "BOVA11 ou Trend Bolsa Brasileira", "ETFs - Brasil", 22),
    rv("ETF - Global", "IVVB11 ou Trend Bolsa Americana", "ETFs - Global", 25),
  ...
  Agressivo: [
    ...
    rf("Tesouro IPCA+", "Prazo maior que 5 anos", 10),
    rv("ETF - Brasil", "BOVA11 ou Trend Bolsa Brasileira", "ETFs - Brasil", 20),
    rv("ETF - Global", "IVVB11 ou Trend Bolsa Americana", "ETFs - Global", 25),
